...
- **the state directory** refers to `.kiro/agent-state/cv-spell-format-reviewer/`
  — this agent's `Per_Agent_State_Directory`.
- **the findings directory** refers to
  `.kiro/agent-state/cv-workflow/findings/cv-spell-format-reviewer/` — where you
...
- `.kiro/agent-state/cv-workflow/findings/cv-spell-format-reviewer/**` — your
  Findings file for the iteration.
- `.kiro/agent-state/cv-spell-format-reviewer/**` — your own state, including
  `resume_state.md`.
...
`.kiro/agent-state/cv-workflow/findings/cv-spell-format-reviewer/iteration-<n>.json`,
...
You maintain `.kiro/agent-state/cv-spell-format-reviewer/resume_state.md` as

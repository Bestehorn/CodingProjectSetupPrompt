...
- **the state directory** refers to
  `.kiro/agent-state/cv-language-content-reviewer/` — this agent's
  `Per_Agent_State_Directory`.
- **the findings directory** refers to
  `.kiro/agent-state/cv-workflow/findings/cv-language-content-reviewer/` —
...
- `.kiro/agent-state/cv-language-content-reviewer/**` — your own state,
...
`.kiro/agent-state/cv-workflow/findings/cv-language-content-reviewer/iteration-<n>.json`,
...
You maintain `.kiro/agent-state/cv-language-content-reviewer/resume_state.md`
